...
public class RasrRequestSample {
	...
	private void sendBytesRequest() {
		...
		byte[] content = ByteUtils.inputStream2ByteArray("C:/Users/zslt_hyh/Downloads/java_realtime_asr_sdk_v1.1/java_realtime_asr_sdk/test_wav/8k/8k.wav");
...
*/
		 AsrBaseConfig.appId = "1259617172";
		 AsrBaseConfig.secretId = "AKIDdihWCxqIj1ERlwJkZEj8NApLhtyvpQzU";
		 AsrBaseConfig.secretKey = "bbXNSRI9mHkFcqvqdKtsAK7iBUhk9OXU";
		...
		AsrGlobelConfig.RECONNECTION_TIMES =3;
	}
